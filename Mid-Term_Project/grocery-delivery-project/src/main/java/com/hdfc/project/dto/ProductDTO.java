...
public class ProductDTO {
	...
	public ProductDTO(String productName, String productDescription, double productPrice, String productBrand,
	...
	public String toString() {
		return "ProductDTO [productName=" + productName + ", productDescription=" + productDescription
